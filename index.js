...
const {client,init} = require("./src/client");
const events = require("./src/events");

const { REST, ActionRowBuilder, SelectMenuBuilder , ButtonBuilder, ButtonStyle, EmbedBuilder, Events, AttachmentBuilder} = require("discord.js");
